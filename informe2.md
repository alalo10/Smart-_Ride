...
## Objetivo General:
Desarrollar una plataforma móvil IoT, que integre una aplicación exportada como apk que utiliza la tecnología NFC y servicios en la nube de Smart Campus UIS y trazabilidad en tiempo real de Vehículos de Movilidad Personal (VMP) en el campus central de la UIS por dos porterías.
