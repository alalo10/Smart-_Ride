...
<p style="text-align: justify;">Nuestro proyecto surge de la necesidad de establecer un **carril exclusivo y automatizado** que no solo agilice el flujo vehicular, sino que garantice la trazabilidad total de cada unidad. La problemática no es solo la entrada y salida, sino la falta de un mecanismo confiable para la gestión de préstamos entre usuarios y la verificación de identidad del propietario en tiempo real. </p>
